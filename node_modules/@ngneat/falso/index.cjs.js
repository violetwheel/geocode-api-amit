...
function fake(data, options) {
  var dataSource = Array.isArray(data) ? function () {
...
function getRandomInRange(_a) {
  var _b = _a === void 0 ? {} : _a,
      _c = _b.min,
      min = _c === void 0 ? 1.0 : _c,
      _d = _b.max,
      max = _d === void 0 ? 9999.99 : _d,
      _e = _b.fraction,
      fraction = _e === void 0 ? 0 : _e;
...
function randAccount(options) {
  ...
  var accountLength = (_a = options === null || options === void 0 ? void 0 : options.accountLength) !== null && _a !== void 0 ? _a : 9;

  var factory = function factory() {
    return Array(accountLength).fill('#').join('').replace(/#/g, function () {
...
var alphaChars = 'abcdefghijklmnopqrstuvwxyz'; // TODO
var numericAlphaChars = "" + numericChars + alphaChars + alphaChars.split('').map(function (v) {
  return v.toUpperCase();
}).join('');

function generator$1(size, chars) {
  if (size === void 0) {
    size = 8;
  }

  if (chars === void 0) {
    chars = numericAlphaChars;
  }

  var result = '';

  for (var i = size; i > 0; --i) result += chars[Math.floor(random() * chars.length)];
...
function randSequence(options) {
  return fake(function () {
    return generator$1(options === null || options === void 0 ? void 0 : options.size, options === null || options === void 0 ? void 0 : options.chars);
  }, options);
}
...
function randNumber(options) {
  var o = {
    min: (options === null || options === void 0 ? void 0 : options.min) || 0,
    max: (options === null || options === void 0 ? void 0 : options.max) || 999999,
    precision: options === null || options === void 0 ? void 0 : options.precision
  };
  return fake(function () {
    var num = getRandomInRange(o);
...
function randAlphaNumeric(options) {
  return fake(function () {
    return randBoolean() ? randAlpha() : randNumber({
      min: 0,
      max: 9
    });
  }, options);
...
function randFileName(options) {
  ...
  var ext = (_a = options === null || options === void 0 ? void 0 : options.extension) !== null && _a !== void 0 ? _a : 'pdf';
  return fake(function () {
    return randElement(data$1R) + "." + ext;
  }, options);
}
...
var serviceArn = {
  s3: function () {
    return "::" + randDirectoryPath() + "/*";
  },
  iam: function () {
    return ":" + randAccount() + ":" + fake(['user', 'group']) + "/*";
  },
  sqs: function () {
    return randAwsRegion() + ":" + randAccount() + ":queue" + randNumber({
      min: 1,
      max: 10
    });
  },
  lambda: function () {
    return randAwsRegion() + ":" + randAccount() + ":function:" + randFileName().replace(/_/g, '-');
  }
};
/**
...
function randArn(options) {
  return fake(function () {
    var partition = fake(partitions);
    var service = fake(services);
...
function randAvatar(options) {
  ...
  var size = (_a = options === null || options === void 0 ? void 0 : options.size) !== null && _a !== void 0 ? _a : 100;
  return fake(function () {
...
function randBetweenDate(options) {
  var from = options.from.getTime();
  var to = options.to.getTime();
...
function randBinary(options) {
  return fake(function () {
    var RADIX = 2;
    var randomNumber = getRandomInRange({
      min: 0,
...
function randBook(options) {
  var bookData = (options === null || options === void 0 ? void 0 : options.category) ? data$1L.filter(function (_a) {
...
function randCreditCardNumber(options) {
  ...
  var brand = (_a = options === null || options === void 0 ? void 0 : options.brand) !== null && _a !== void 0 ? _a : rand(Object.keys(data$1v));
  var formats = (_b = data$1v.find(function (card) {
    return card.brand === brand;
  })) === null || _b === void 0 ? void 0 : _b.formats;
  var fallBackFormat = ['#### #### #### ####'];

  var factory = function factory() {
    return randElement(formats || fallBackFormat).replace(/#/g, function () {
      return getRandomInRange({
        min: 0,
        max: 9
      }).toString();
...
function randDomainName(options) {
  return fake(function () {
    return randWord() + "." + randDomainSuffix();
  }, options);
}
...
function randFirstName(options) {
  ...
  var withAccents = (_a = options === null || options === void 0 ? void 0 : options.withAccents) !== null && _a !== void 0 ? _a : randBoolean();
  var names = withAccents ? data$1f['withAccents'] : data$1f['withoutAccents'];
...
function randLastName(options) {
  ...
  var withAccents = (_a = options === null || options === void 0 ? void 0 : options.withAccents) !== null && _a !== void 0 ? _a : randBoolean();
  var names = withAccents ? data$1e['withAccents'] : data$1e['withoutAccents'];
  return fake(names, options);
}
...
function randFormattedName(options) {
  ...
  var separator = '';
  var firstName = (_a = options === null || options === void 0 ? void 0 : options.firstName) !== null && _a !== void 0 ? _a : randFirstName({
    withAccents: false
  });
  var lastName = (_b = options === null || options === void 0 ? void 0 : options.lastName) !== null && _b !== void 0 ? _b : randLastName({
    withAccents: false
  });

  if (!(options === null || options === void 0 ? void 0 : options.nameSeparator)) {
    separator = fake(['.', '-', '_', '+', '']);
  } else if (options.nameSeparator !== 'none') {
    separator = options.nameSeparator;
  }

  var name = (firstName + " " + lastName).replace(' ', separator);
...
function randEmail(options) {
  var factory = function factory() {
    var emailProvider = (options === null || options === void 0 ? void 0 : options.provider) || randEmailProvider();
    var formattedName = randFormattedName(options);
    var emailSuffix = (options === null || options === void 0 ? void 0 : options.suffix) || randDomainSuffix();
...
function randFloat(options) {
  ...
  var o = __assign(__assign({}, options), {
    fraction: (_a = options === null || options === void 0 ? void 0 : options.fraction) !== null && _a !== void 0 ? _a : 2
  });
...
function randFontSize(options) {
  return fake(function () {
    ...
    var length = randNumber({
      min: 0,
      max: 2000,
      fraction: 2
    });
    var suffix = (_a = options === null || options === void 0 ? void 0 : options.suffix) !== null && _a !== void 0 ? _a : 'px';
...
var _a$1;
var totalOrigins = (_a$1 = Object.keys(data$16)) === null || _a$1 === void 0 ? void 0 : _a$1.length;
/**
...
function randFood(options) {
  var foodData = data$16;
  var origin = options === null || options === void 0 ? void 0 : options.origin;
  ...
  var factory = function factory() {
    ...
    var originIndex = getRandomInRange({
      min: 0,
      max: totalOrigins - 1
    });
    var randomOrigin = Object.keys(foodData)[originIndex];
...
function randFullName(options) {
  var nameOptions = {
    withAccents: options === null || options === void 0 ? void 0 : options.withAccents
  };
  return fake(function () {
...
function randFutureDate(options) {
  ...
  var years = (_a = options === null || options === void 0 ? void 0 : options.years) !== null && _a !== void 0 ? _a : 1;

  if (years <= 0) {
    throw new Error('Years must be positive, use past() instead');
  }

  var yearsInMilliseconds = years * 365 * 24 * 60 * 60 * 1000;
  var from = new Date();
  var to = new Date(from.getTime() + yearsInMilliseconds);
  return fake(function () {
...
function randGender(options) {
  return fake((options === null || options === void 0 ? void 0 : options.code) ? data$12 : data$13, options);
}
...
function randGitShortSha(options) {
  return fake(function () {
    ...
    for (var i = 0; i < commitShortShaLen; i++) {
      sha += randAlphaNumeric();
    }
  ...
  var factory = function factory() {
    var _a = [getRandomInRange({
      ...
      max: 1
        ...
        l = _a[2],
        a = _a[3];
    return (options === null || options === void 0 ? void 0 : options.alpha) ? "hsla(" + h + ", " + s + "%, " + l + "%, " + a + ")" : "hsl(" + h + ", " + s + "%, " + l + "%)";
  };
...
function randImg(options) {
  ...
  var _d = [(_a = options === null || options === void 0 ? void 0 : options.width) !== null && _a !== void 0 ? _a : 500, (_b = options === null || options === void 0 ? void 0 : options.height) !== null && _b !== void 0 ? _b : 500, (_c = options === null || options === void 0 ? void 0 : options.category) !== null && _c !== void 0 ? _c : ''],
      width = _d[0],
      height = _d[1],
      category = _d[2];
  return fake(function () {
    return "https://placeimg.com/" + width + "/" + height + (category ? "/" + category : category);
  }, options);
}
...
function randLanguage(options) {
  return fake((options === null || options === void 0 ? void 0 : options.code) ? data$T : data$U, options);
}
...
function randLine(options) {
  ...
  var lineCount = (_a = options === null || options === void 0 ? void 0 : options.lineCount) !== null && _a !== void 0 ? _a : 5;
...
function randMac(options) {
  return fake(function () {
    return Array.from({
      ...
      return randHexaDecimal() + randHexaDecimal();
    }).join('-');
  }, options);
}
...
function randMask(options) {
  return fake(function () {
    ...
    var _d = [(_a = options === null || options === void 0 ? void 0 : options.mask) !== null && _a !== void 0 ? _a : '@##@#', (_b = options === null || options === void 0 ? void 0 : options.char) !== null && _b !== void 0 ? _b : '@', (_c = options === null || options === void 0 ? void 0 : options.digit) !== null && _c !== void 0 ? _c : '#'],
        mask = _d[0],
        char = _d[1],
        digit = _d[2];
    return mask.split('').map(function (item) {
...
function randMonth(options) {
  var monthData = data$O;
  var abbreviation = options === null || options === void 0 ? void 0 : options.abbreviation;

  var factory = function factory() {
    var randMonth = randElement(monthData);
...
function randNearbyGPSCoordinate(options) {
  return fake(function () {
    return [randLatitude(), randLongitude()];
  }, options);
}
...
function randPassword(options) {
  var size = (options === null || options === void 0 ? void 0 : options.size) || 15;
  return fake(function () {
    return randSequence({
      size: size
    });
...
function randPastDate(options) {
  ...
  var yearsInMilliseconds = years * 365 * 24 * 60 * 60 * 1000;
  var to = new Date();
  var from = new Date(to.getTime() - yearsInMilliseconds);
  return fake(function () {
    return randBetweenDate({
      from: from,
      to: to
...
function randPhoneNumber(options) {
  ...
  if (options === null || options === void 0 ? void 0 : options.countryCode) {
    formats = ((_a = data$F.find(function (country) {
      return country.countryCode.includes(options.countryCode);
    })) === null || _a === void 0 ? void 0 : _a.formats) || [];
  } else {
    formats = data$F.map(function (_a) {
      var formats = _a.formats;
      return formats;
    }).flat();
  }

  var phoneNumber = Array.from({
    length: (options === null || options === void 0 ? void 0 : options.length) || 1
  }, function (_, index) {
    return randMask({
...
function randUserName(options) {
  return fake(function () {
    ...
    var firstName = (_a = options === null || options === void 0 ? void 0 : options.firstName) !== null && _a !== void 0 ? _a : randFirstName();
    var lastName = (_b = options === null || options === void 0 ? void 0 : options.lastName) !== null && _b !== void 0 ? _b : randLastName();
    var userName = (firstName + " " + lastName).replace(' ', fake(['.', '_']));
...
function randAddress(options) {
  ...
  var includeCounty = (_a = options === null || options === void 0 ? void 0 : options.includeCounty) !== null && _a !== void 0 ? _a : true;
  var includeCountry = (_b = options === null || options === void 0 ? void 0 : options.includeCountry) !== null && _b !== void 0 ? _b : true;
...
function randText(options) {
  ...
  var charCount = (_a = options === null || options === void 0 ? void 0 : options.charCount) !== null && _a !== void 0 ? _a : 10;
...
function randProtocol(options) {
  return fake((options === null || options === void 0 ? void 0 : options.fullName) ? data$t : data$u, options);
}
...
function randRecentDate(options) {
  ...
  var days = (_a = options === null || options === void 0 ? void 0 : options.days) !== null && _a !== void 0 ? _a : 1;
  ...
  var to = new Date();
  var from = new Date(to.getTime() - daysInMilliseconds);
  return fake(function () {
    return randBetweenDate({
      from: from,
      to: to
  ...
  var factory = function factory() {
    var _a = [getRandomInRange({
      ...
      max: 1
        ...
        b = _a[2],
        a = _a[3];
    return (options === null || options === void 0 ? void 0 : options.alpha) ? "rgba(" + r + ", " + g + ", " + b + ", " + a + ")" : "rgb(" + r + ", " + g + ", " + b + ")";
  };
...
function randSemver(options) {
  return fake(function () {
    ...
    return "" + ((options === null || options === void 0 ? void 0 : options.prefix) || '') + version;
  }, options);
}
...
function randSlug(options) {
  return fake(function () {
    var numberOfWordsInSlug = getRandomInRange({
      min: 3,
      max: 10
    });
    var randomWords = randWord({
...
function randSoonDate(options) {
  ...
  var daysInMilliseconds = days * 24 * 60 * 60 * 1000;
  var from = new Date();
  var to = new Date(from.getTime() + daysInMilliseconds);
  return fake(function () {
    return randBetweenDate({
      from: from,
      to: to
...
var _a;
var categoriesCount = (_a = Object.keys(data$l)) === null || _a === void 0 ? void 0 : _a.length;
/**
...
function randSports(options) {
  var sportsData = data$l;
  var category = options === null || options === void 0 ? void 0 : options.category;
  ...
  var factory = function factory() {
    ...
    var randIndex = getRandomInRange({
      min: 0,
      max: categoriesCount - 1,
      fraction: 0
    });
    var randomOrigin = Object.keys(sportsData)[randIndex];
...
function randSportsTeam(options) {
  var teamNameFunctions = [randAmericanFootballTeam(), randBaseballTeam(), randBasketballTeam(), randFootballTeam(), randIceHockeyTeam()];
  return fake(function () {
...
function randStatus(options) {
  ...
  if (options === null || options === void 0 ? void 0 : options.type) {
    var filteredStatuses = data$i.filter(function (status) {
      return status.type.includes(options.type);
    });
    statuses = filteredStatuses.map(function (_a) {
      var status = _a.status;
      return status;
    }).flat() || [];
  } else {
    statuses = data$i.map(function (_a) {
      var status = _a.status;
      return status;
    }).flat();
  }
...
function randSuperhero(options) {
  var factory = function factory() {
    var heroes = (options === null || options === void 0 ? void 0 : options.company) ? data$g.filter(function (_a) {
      var company = _a.company;
      return company === options.company;
    }) : data$g;
    return __assign(__assign({}, randElement(heroes)), {
      id: randUuid()
    });
  };
...
function generateStandardFlightNumber(_a) {
  var prefix = _a.prefix,
      _b = _a.suffixMin,
      suffixMin = _b === void 0 ? 1000 : _b,
      _c = _a.suffixMax,
      suffixMax = _c === void 0 ? 9999 : _c;
...
function randFlightNumber(options) {
  ...
  var airline = (_a = options === null || options === void 0 ? void 0 : options.airline) !== null && _a !== void 0 ? _a : rand(data$2);
...
function randFlightDetails(options) {
  var factory = function factory() {
    ...
    var airline = (_a = options === null || options === void 0 ? void 0 : options.airline) !== null && _a !== void 0 ? _a : randAirline();
    var passenger = (_b = options === null || options === void 0 ? void 0 : options.passenger) !== null && _b !== void 0 ? _b : randFullName();
...
function randCreditCard(options) {
  var factory = function factory() {
    ...
    var fullName = (_a = options === null || options === void 0 ? void 0 : options.fullName) !== null && _a !== void 0 ? _a : randPersonTitle() + " " + randFullName({
      withAccents: false
    });
    var brand = (_b = options === null || options === void 0 ? void 0 : options.brand) !== null && _b !== void 0 ? _b : randCreditCardBrand();
    var dateOptions = {
      month: 'numeric',
      year: '2-digit'
    };
    var validFrom = randPastDate({
      years: 1
    }).toLocaleDateString('en-GB', dateOptions);
    var untilEnd = randFutureDate({
      years: 2
    }).toLocaleDateString('en-GB', dateOptions);
    return {
      fullName: fullName,
...
var generateRandomValue = function generateRandomValue() {
  var availableValuesGenerators = [randBoolean(), randNumber(), randNumber({
    length: randNumber({
      min: 1,
      max: 10
    })
...
function randJSON(options) {
  ...
  var objectSize = (_a = options === null || options === void 0 ? void 0 : options.totalKeys) !== null && _a !== void 0 ? _a : randNumber({
    min: (options === null || options === void 0 ? void 0 : options.minKeys) || 1,
    max: (options === null || options === void 0 ? void 0 : options.maxKeys) || 99
  });
...
function randCodeSnippet(options) {
  ...
  var lang = (_a = options === null || options === void 0 ? void 0 : options.lang) !== null && _a !== void 0 ? _a : 'javascript';
  return fake(function () {
    return data[lang];
  }, options);
}
...
function randTextRange(options) {
  ...
  var factory = function factory() {
    var charCount = getRandomInRange({
      min: min,
      max: max
    });
    return randText({
...
function randAirportName(options) {
  var factory = function factory() {
    return rand(data$1.map(function (_a) {
      var name = _a.name;
      return name;
    }));
  };
